  ...
  return (
    <div>
      ...
      <main>
        ...
        <div className={isLoading ? styles.display_none : ""}>
          ...
          <section className={styles.summary_container}>
            <p className={styles.summary}>
              ...
              internal divisions threaten to tear the gang apart, Arthur must
              make a choice between his own ideals and loyalty to the gang who
              raised him.
            </p>
          </section>
          <SectionCards />
